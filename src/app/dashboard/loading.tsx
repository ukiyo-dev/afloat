export default function Loading() {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-paper/80 backdrop-blur-sm">
      <div className="panel-brutal !py-8 !px-12 flex flex-col items-center gap-6 animate-pulse border-4 border-ink shadow-[12px_12px_0_0_rgb(var(--color-shadow))] bg-highlight">
